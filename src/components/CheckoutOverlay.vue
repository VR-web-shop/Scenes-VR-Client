<template>
    <div v-if="show" class="flex gap-3 fixed top-0 right-0 left-0 bottom-0 overflow-y-auto w-full h-screen" style="z-index: 2;">
        <div 
            class="h-full w-full bg-white shadow-md p-3 overflow-y-auto border border-gray-300">
